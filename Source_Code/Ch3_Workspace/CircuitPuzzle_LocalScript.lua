...
frame.Size = UDim2.new(0.4, 0, 0.4, 0) -- Square proportions
...
local function forceFrameSquare()
	local existingConstraint = frame:FindFirstChildOfClass("UIAspectRatioConstraint")
	if not existingConstraint then
		local constraint = Instance.new("UIAspectRatioConstraint")
		constraint.AspectRatio = 1
		constraint.AspectType = Enum.AspectType.ScaleWithParentSize -- Optional for clarity
...
guiTriggerEvent.OnClientEvent:Connect(function()
	...
	forceFrameSquare() -- ?? Make the whole puzzle square
